...
private :
    ...
    THStack *hs[21]; //Define array of stacekd histograms
    ...
    TH1F *hP[6]; //array of histo, Rct isolated events

    TH1F *hPlog[6]; //array of histo, Rct isolated events
    
    TH1F *hPerr[6]; //array of histo, Rct isolated events

    TH1F *hPlogerr[6]; //array of histo, Rct isolated events
    
    TH1F *hPz[6]; //array of histo, Rct isolated events
    
    TH1F *hPzerr[6]; //array of histo, Rct isolated events
...
void Events::MyInit()
{
    ...
    hs[7] = new THStack("hs7","Electron pT, from reconstructed isolated particles");
    hs[8] = new THStack("hs8","Muon pT, from reconstructed isolated particles");
    
    hs[9] = new THStack("hs9","Electron Impact parameter in xy");
    hs[10] = new THStack("hs10","Muon Impact parameter in xy");
    hs[11] = new THStack("hs11","Significance of Electron Impact parameter in xy");
    hs[12] = new THStack("hs12","Significance of Muon Impact parameter in xy");
    
    hs[13] = new THStack("hs13","Electron Impact parameter in z");
    hs[14] = new THStack("hs14","Muon Impact parameter in z");
    hs[15] = new THStack("hs15","Significance of Electron Impact parameter in z");
    hs[16] = new THStack("hs16","Significance of Muon Impact parameter in z");
    
    hs[17] = new THStack("hs17","Electron Impact parameter in xy (log bin)");
    hs[18] = new THStack("hs18","Muon Impact parameter in xy (log bin)");
    hs[19] = new THStack("hs19","Significance of Electron Impact parameter in xy (log bin)");
    hs[20] = new THStack("hs20","Significance of Muon Impact parameter in xy (log bin)");
    ...
    hP[0] = new TH1F("hPee","Impact Parameter of Ele, from electron events",40, 0, 0.08);
    hP[1] = new TH1F("hPem","Impact Parameter of Muon, from electron events",10, 0, 0.2);
    
    hP[2] = new TH1F("hPme","Impact Parameter of Ele, from muon events",40, 0, 0.08);
    hP[3] = new TH1F("hPmmf","Impact Parameter of Muon, from muon events",10, 0, 0.20);
    
    hP[4] = new TH1F("hPte","Impact Parameter of Ele, from tau events",40, 0, 0.08);
    hP[5] = new TH1F("hPtmf","Impact Parameter of Muon, from tau events",10, 0, 0.20);
    
    
    data = new TH1F("data","Impact Parameter of Muon",10, 0, 0.20);

    
    hPlog[0] = new TH1F("hPlogee","Impact Parameter of Ele, from electron events",90, -14, 1);
    hPlog[1] = new TH1F("hPlogem","Impact Parameter of Muon, from electron events",90, -14, 1.0);
    
    hPlog[2] = new TH1F("hPlogme","Impact Parameter of Ele, from muon events",90, -14, 1.0);
    hPlog[3] = new TH1F("hPlogmm","Impact Parameter of Muon, from muon events",90, -14, 1);
    
    hPlog[4] = new TH1F("hPlogte","Impact Parameter of Ele, from tau events",90, -14, 1);
    hPlog[5] = new TH1F("hPlogtm","Impact Parameter of Muon, from tau events",90, -14, 1);

    hPlogerr[0] = new TH1F("hPlogeer","Impact Parameter of Ele over error, from electron events",40, 0, 18.0);
    hPlogerr[1] = new TH1F("hPlogemr","Impact Parameter of Muon over error, from electron events",40, 0, 50.0);
    
    hPlogerr[2] = new TH1F("hPlogmer","Impact Parameter of Ele over error, from muon events",40, 0, 30.0);
    hPlogerr[3] = new TH1F("hPlogmmr","Impact Parameter of Muon over error, from muon events",40, 0, 35.0);
    
    hPlogerr[4] = new TH1F("hPlogter","Impact Parameter of Ele over error, from tau events",40, 0, 18.0);
    hPlogerr[5] = new TH1F("hPlogtmr","Impact Parameter of Muon over error, from tau events",40, 0, 35.0);
    
    
    hPerr[0] = new TH1F("hPeer","Impact Parameter of Ele over error, from electron events",40, 0, 18.0);
    hPerr[1] = new TH1F("hPemr","Impact Parameter of Muon over error, from electron events",40, 0, 50.0);
    
    hPerr[2] = new TH1F("hPmer","Impact Parameter of Ele over error, from muon events",40, 0, 30.0);
    hPerr[3] = new TH1F("hPmmr","Impact Parameter of Muon over error, from muon events",40, 0, 37.0);
    
    hPerr[4] = new TH1F("hPter","Impact Parameter of Ele over error, from tau events",40, 0, 18.0);
    hPerr[5] = new TH1F("hPtmr","Impact Parameter of Muon over error, from tau events",40, 0, 37.0);
    
    
    hPz[0] = new TH1F("hPzee","Impact Parameter of Ele, from electron events",40, 0, 0.25);
    hPz[1] = new TH1F("hPzem","Impact Parameter of Muon, from electron events",40, 0, 0.35);
    
    hPz[2] = new TH1F("hPzme","Impact Parameter of Ele, from muon events",40, 0, 0.35);
    hPz[3] = new TH1F("hPzmm","Impact Parameter of Muon, from muon events",40, 0, 0.27);
    
    hPz[4] = new TH1F("hPzte","Impact Parameter of Ele, from tau events",40, 0, 0.25);
    hPz[5] = new TH1F("hPztm","Impact Parameter of Muon, from tau events",40, 0, 0.27);
    
    hPzerr[0] = new TH1F("hPzeer","Impact Parameter of Ele over error, from electron events",40, 0, 30.0);
    hPzerr[1] = new TH1F("hPzemr","Impact Parameter of Muon over error, from electron events",40, 0, 35.0);
    
    hPzerr[2] = new TH1F("hPzmer","Impact Parameter of Ele over error, from muon events",40, 0, 35.0);
    hPzerr[3] = new TH1F("hPzmmr","Impact Parameter of Muon over error, from muon events",40, 0, 50.0);
    
    hPzerr[4] = new TH1F("hPzter","Impact Parameter of Ele over error, from tau events",40, 0, 30.0);
    hPzerr[5] = new TH1F("hPztmr","Impact Parameter of Muon over error, from tau events",40, 0, 50.0);
    ...
    d[2] = new TCanvas("d2","Electron impact par");
    d[3] = new TCanvas("d3","Muon impact par");
    
    d[4] = new TCanvas("d4","Significance of Electron impact par");
    d[5] = new TCanvas("d5","Significance of Muon impact par");
 
    d[6] = new TCanvas("d6","Electron impact par");
    d[7] = new TCanvas("d7","Muon impact par");
    
    d[8] = new TCanvas("d8","Sigificance of Electron impact par");
    d[9] = new TCanvas("d9","Significance of Muon impact par");
    
    d[10] = new TCanvas("d10","Electron impact par (log bin)");
    d[11] = new TCanvas("d11","Muon impact par (log bin)");

    d[12] = new TCanvas("d12","Muon impact par (fit)");
